...
TEST_F(FakeFileSystemOpTest, RenameDirKeepsChildren) {
    ...
    FakeFileSystem::AddFile({"C:", "Users", "Jef", "Pictures"},
                            "Waterfall.png");
    ...
    EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Geoff", "Pictures"})));
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Geoff", "Pictures", "Waterfall.png"})));
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Geoff", "NOTES.txt"})));
}
...
TEST_F(FakeFileSystemOpTest, RenameWithoutSource) {
    ...
    EXPECT_THROW(FileSystem::Op::Rename(FakeFileSystem::MergeUsingSeparator(
                                            {"C:", "Users", "Jef", "A.txt"}),
...
TEST_F(FakeFileSystemOpTest, RenameFileWithSameDest) {
    ...
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Jef", "NOTES.txt"})));
    FileSystem::Op::Rename(FakeFileSystem::MergeUsingSeparator(
                               {"C:", "Users", "Jef", "NOTES.txt"}),
                           FakeFileSystem::MergeUsingSeparator(
                               {"C:", "Users", "Jef", "NOTES.txt"}));
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
...
TEST_F(FakeFileSystemOpTest, CopyDirKeepsChildren) {
    ...
    EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Jef", "Pictures"})));
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Jef", "Pictures", "Waterfall.png"})));
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Jef", "NOTES.txt"})));

    EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator(
        {"D:", "Users", "Geoff", "Pictures"})));
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
        {"D:", "Users", "Geoff", "Pictures", "Waterfall.png"})));
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
        {"D:", "Users", "Geoff", "NOTES.txt"})));
}
...
TEST_F(FakeFileSystemOpTest, CopyWithoutSource) {
    ...
    EXPECT_THROW(
        FileSystem::Op::CopyRecursive(FakeFileSystem::MergeUsingSeparator(
                                          {"C:", "Users", "Jef", "A.txt"}),
                                      FakeFileSystem::MergeUsingSeparator(
                                          {"C:", "Users", "Jef", "B.txt"})),
...
TEST_F(FakeFileSystemOpTest, RemoveDir) {
    ...
    EXPECT_TRUE(FileSystem::IsDirectory(
        FakeFileSystem::MergeUsingSeparator({"C:", "Users", "Dan"})));
...
TEST_F(FakeFileSystemOpTest, RemoveDirAlsoRemovesChildren) {
    ...
    EXPECT_TRUE(FileSystem::IsDirectory(
        FakeFileSystem::MergeUsingSeparator({"C:", "Users", "Dan"})));
    EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Dan", "Pictures"})));
    EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Dan", "NOTES.txt"})));
    ...
    EXPECT_FALSE(FileSystem::IsDirectory(
        FakeFileSystem::MergeUsingSeparator({"C:", "Users", "Dan"})));
    EXPECT_FALSE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator(
        {"C:", "Users", "Dan", "Pictures"})));
