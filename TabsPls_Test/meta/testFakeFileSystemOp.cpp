...
namespace FakeFileSystemOpTests
{
    ...
    TEST_F(FakeFileSystemOpTest, RenameFile)
    {
        ...
        FileSystem::Op::Rename(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" , "A.txt" }), FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" , "B.txt" }));
    ...
    TEST_F(FakeFileSystemOpTest, RenameDir)
    {
        ...
        FileSystem::Op::Rename(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" }), FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Geoff" }));
    ...
    TEST_F(FakeFileSystemOpTest, RenameDirKeepsChildren)
    {
        ...
        EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Geoff", "Pictures", "Waterfall.png" })));
    ...
    TEST_F(FakeFileSystemOpTest, RenameDirWithSameDest)
    {
        ...
        EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" })));
        FileSystem::Op::Rename(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" }), FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" }));
        EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" })));
    }
    ...
    TEST_F(FakeFileSystemOpTest, RenameFileWithSameDest)
    {
        ...
        FileSystem::Op::Rename(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "NOTES.txt" }), FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "NOTES.txt" }));
        EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "NOTES.txt" })));
    }
    ...
    TEST_F(FakeFileSystemOpTest, RenameRoot)
    {
        ...
        FileSystem::Op::Rename("C:", "D:"); //This is not expected to work on an actual filesystem, but there are no write restrictions on the FakeFileSystem
    ...
    TEST_F(FakeFileSystemOpTest, CopyFile)
    {
        ...
        FileSystem::Op::CopyRecursive(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" , "A.txt" }), FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" , "B.txt" }));
    ...
    TEST_F(FakeFileSystemOpTest, CopyDir)
    {
        ...
        FileSystem::Op::CopyRecursive(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" }), FakeFileSystem::MergeUsingSeparator({ "D:", "Users", "Geoff" }));
    ...
    TEST_F(FakeFileSystemOpTest, CopyDirKeepsChildren)
    {
        ...
        EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "Pictures", "Waterfall.png" })));
        EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "NOTES.txt" })));

        EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator({ "D:", "Users", "Geoff", "Pictures" })));
        EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator({ "D:", "Users", "Geoff", "Pictures", "Waterfall.png" })));
    ...
    TEST_F(FakeFileSystemOpTest, CopyDirWithSameDest)
    {
        ...
        EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" })));
        EXPECT_THROW(FileSystem::Op::CopyRecursive(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" }), FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" })), FileSystem::Op::CopyException);
        EXPECT_TRUE(FileSystem::IsDirectory(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef" })));
    }
    ...
    TEST_F(FakeFileSystemOpTest, CopyFileWithSameDest)
    {
        ...
        EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "NOTES.txt" })));
        EXPECT_THROW(FileSystem::Op::CopyRecursive(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "NOTES.txt" }), FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "NOTES.txt" })), FileSystem::Op::CopyException);
        EXPECT_TRUE(FileSystem::IsRegularFile(FakeFileSystem::MergeUsingSeparator({ "C:", "Users", "Jef", "NOTES.txt" })));
    }
    ...
    TEST_F(FakeFileSystemOpTest, CopyFileWithExisingDirDest)
    {
        ...
        /*This one might seem odd, but if the intent is to copy the file 'Jef' into C:\Users\Geoff,
        Then the command should be 'CopyRecursive(C:\Users\Jef, C:\Users\Geoff\Jef)'
        */
    ...
    TEST_F(FakeFileSystemOpTest, CopyRoot)
    {
        ...
        FileSystem::Op::CopyRecursive("C:", "D:"); //This is not expected to work on an actual filesystem, but there are no write restrictions on the FakeFileSystem
