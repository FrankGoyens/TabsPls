...
void RobustDirectoryHistoryStore::OnNewDirectory(const FileSystem::Directory& dir) { m_store.OnNewDirectory(dir); }
...
const FileSystem::Directory RobustDirectoryHistoryStore::GetCurrent() const { return m_store.GetCurrent(); }
